...
export default function UserProfile() {
    ...
    return (
        ...
        >
            ...
            {/* Dropdown Menu - 使用 visibility/opacity 配合 transition 实现平滑效果 */}
            <div
                className={`
                    absolute top-12 right-0 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden transition-all duration-200 origin-top-right
