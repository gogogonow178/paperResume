            ...
            <header style={{
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', columnGap: '12px', rowGap: '4px', fontSize: '13px', color: '#86868B', maxWidth: 'calc(100% - 100px)' }}>
                        ...
                        {basicInfo.wechat && (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', maxWidth: '180px' }}>
                                ...
                                <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{basicInfo.wechat}</span>
                            </span>
                        )}
                        {basicInfo.website && (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', color: '#0071E3', maxWidth: '200px' }}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ flexShrink: 0 }}>
                                    <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" />
                                    <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
                                </svg>
                                <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{basicInfo.website}</span>
                            </span>
                        )}
                    </div>
                </div>
