...
// 套餐配置（与前端 PricingModal 保持一致）
const TIERS = {
    trial: { price: 490, credits: 5, name: '尝鲜包' },     // 4.9 元 = 490 分
    pro: { price: 990, credits: 20, name: '求职包' },     // 9.9 元 = 990 分
    max: { price: 1990, credits: 50, name: '面霸包' }     // 19.9 元 = 1990 分
}
